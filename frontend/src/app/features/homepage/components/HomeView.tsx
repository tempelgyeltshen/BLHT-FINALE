    ...
    <div className="bg-[#fcf8f2] text-[#2b1d14] space-y-20 pb-24 overflow-hidden">
      ...
      <div ref={heroRef} className="relative pt-8 sm:pt-16 pb-6 overflow-hidden">
        ...
        >
          ...
          >
            TOUR OPERATOR LICENSE #BLHT-8842
          </motion.span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-12">
          ...
          >
            ...
            <div className="space-y-2">
              <span className="text-[10px] uppercase tracking-[0.25em] text-[#d96b27] font-sans font-bold block">7 to 12 Night Circuits</span>
              <h3 className="font-serif text-xl sm:text-2xl font-medium text-[#3b2314] group-hover:text-[#d96b27] transition-colors">
                The Himalayan Kingdom Circuit
              </h3>
              <p className="font-serif text-xs text-[#5c3820] leading-relaxed line-clamp-2">
                Traverse Paro, Thimphu, Punakha, Gangtey, and Bumthang across iconic 5-star sanctuary suites with private monastic blessings and helicopter transfers.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-2">
              <span className="text-[10px] uppercase tracking-[0.25em] text-[#d96b27] font-sans font-bold block">Cultural Celebrations</span>
              <h3 className="font-serif text-xl sm:text-2xl font-medium text-[#3b2314] group-hover:text-[#d96b27] transition-colors">
                Sacred Mask Dances & Tshechus 2026
              </h3>
              <p className="font-serif text-xs text-[#5c3820] leading-relaxed line-clamp-2">
                VIP pavilion seating at Paro and Thimphu Tshechu festivals with custom silk Gho and Kira attire tailoring and private lama guided tours.
              </p>
            </div>
          </motion.div>
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-center bg-[#f5eee4] p-6 sm:p-12 border border-[#e2d1be]">
          ...
          <div className="lg:col-span-5 space-y-4 sm:space-y-6 lg:pl-4">
            <span className="text-[10px] font-sans uppercase tracking-[0.25em] text-[#d96b27] font-bold block">Seamless Travel</span>
            <h2 className="font-serif text-2xl sm:text-3xl lg:text-4xl font-medium text-[#3b2314] leading-tight">
              Bhutan Land Of Happiness Travel Service
            </h2>

            <p className="font-serif text-xs sm:text-sm text-[#5c3820] leading-relaxed">
              Traveling to the Kingdom is effortless with direct flight coordination via Drukair and Bhutan Airlines from Bangkok, Singapore, and New Delhi. Bhutan Land Of Happiness Tourism handles all visa processing, flight tickets, and personal concierge services.
            </p>
      ...
      >
        <div className="text-center space-y-2 sm:space-y-3">
          <span className="text-[10px] font-sans tracking-[0.3em] uppercase text-[#d96b27] font-bold">5-Star Sanctuaries</span>
          <h2 className="font-serif text-2xl sm:text-3xl lg:text-4xl font-medium text-[#3b2314]">Luxury Valleys & Lodges</h2>
        </div>
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <div className="pt-2 flex items-center justify-between text-xs text-[#3b2314] font-serif border-t border-[#e2d1be]">
                  <span className="font-semibold text-[#d96b27]">${hotel.pricePerNightUSD.toLocaleString()} / night</span>
                  <button 
                    onClick={(e) => {
                      e.stopPropagation();
        ...
        <div className="bg-[#3b2314] text-[#fcf8f2] p-6 sm:p-12 lg:p-16 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center border border-[#d96b27]/30 shadow-xl">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-6 order-2 lg:order-1">
            ...
            <h2 className="font-serif text-2xl sm:text-4xl lg:text-5xl font-medium leading-tight">
              Bhutan Land Of Happiness 2026 PDF Brochure
            </h2>
            <p className="font-serif text-xs sm:text-sm text-[#e2d1be] leading-relaxed">
              Explore complete day-by-day itineraries, flight logistics, visa guidance, and luxury suite photography in our interactive reader or direct PDF download.
            </p>
