...
import { MapPin, Phone, Mail, Clock, Send, CheckCircle2, Shield, Award } from 'lucide-react';
...
export const ContactView: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setSubmitted(true);
    showToast('Inquiry submitted to Concierge HQ Thimphu');
  };
        ...
        >
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl border border-stone-300 text-xs focus:ring-2 focus:ring-amber-800 focus:outline-hidden"
                  />
                </div>
              ...
              <div>
                <label className="block text-xs font-semibold text-stone-700 mb-1">Message / Travel Aspirations</label>
                <textarea
                  rows={4}
                  required
              ...
              <button
                type="submit"
                className="w-full py-3.5 rounded-xl bg-gradient-to-r from-amber-800 to-amber-950 hover:from-amber-900 hover:to-amber-950 text-amber-50 font-bold text-xs shadow-md flex items-center justify-center gap-2 cursor-pointer transition-all"
              >
