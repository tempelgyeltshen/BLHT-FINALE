...
import { Award, Shield, Heart, Compass, MapPin, Sparkles, CheckCircle2, UserCheck, Car, Building2, ExternalLink, Mail, Phone, BookOpen } from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16 overflow-hidden">
      ...
      <motion.div 
        ...
        className="bg-[#3b2314] text-amber-50 rounded-3xl p-8 sm:p-12 border border-[#d96b27]/30 shadow-xl space-y-4 text-center"
      >
        ...
        <p className="text-amber-200/90 text-sm sm:text-base font-serif max-w-3xl mx-auto leading-relaxed">
