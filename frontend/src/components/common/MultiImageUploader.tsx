...
import { Upload, Plus, X, Trash2, ArrowLeft, ArrowRight, Image as ImageIcon, Link as LinkIcon, AlertCircle } from 'lucide-react';
...
export const MultiImageUploader: React.FC<MultiImageUploaderProps> = ({
  ...
  // Handle Desktop Multiple File Selection
  const handleFilesSelected = (filesList: FileList) => {
    setErrorMsg(null);
      ...
      <div className="flex items-center justify-between flex-wrap gap-2">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-3 py-1.5 bg-amber-900 hover:bg-amber-850 text-amber-50 text-xs font-bold rounded-lg flex items-center gap-1.5 cursor-pointer shadow-xs"
          >
          ...
          <button
            ...
            className="px-3 py-1.5 bg-stone-200 hover:bg-stone-300 text-stone-800 text-xs font-semibold rounded-lg flex items-center gap-1 cursor-pointer"
          >
              ...
              <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-between p-2">
                ...
                <div className="flex items-center justify-between text-white">
                  ...
                  <span className="text-[10px] font-mono text-stone-300">
                    {url.startsWith('data:') ? 'Base64 File' : 'Image Link'}
                  </span>
                  <button
                    type="button"
