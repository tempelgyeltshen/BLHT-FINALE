...
import { MessageSquare, Mail, Phone, Calendar, CheckCircle2, Clock, Send } from 'lucide-react';
          ...
          {selectedInquiry ? (
            <div className="lg:col-span-2 bg-white rounded-2xl border border-amber-200 p-6 shadow-sm space-y-6">
              ...
              <form onSubmit={handleSendReply} className="pt-4 border-t space-y-3">
                ...
                <button
                  type="submit"
                  className="px-5 py-2.5 rounded-xl bg-amber-900 hover:bg-amber-850 text-amber-50 font-bold text-xs flex items-center gap-2 cursor-pointer"
                >
